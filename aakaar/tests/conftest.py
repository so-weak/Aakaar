...
from aakaar.workers.browser import FakeBrowserPool
...
def deps(
    ...
    deps = AppDependencies(
        settings=Settings(
            ...
            # Tests fire many requests in quick succession from one client;
            # leave the limiter off so it doesn't trip mid-suite.
            rate_limit_enabled=False,
            # Don't start the background scheduler loop under TestClient.
