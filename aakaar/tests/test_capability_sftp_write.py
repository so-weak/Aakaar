...
Covers:
  - file_uri must be aakaar:// (refuse arbitrary local paths)
...
from aakaar.capabilities.sftp_write import _user_facing_basename, handler
...
def test_user_facing_basename_handles_uuid_prefix_and_fallback() -> None:
    uuid_prefixed = (
        "aakaar://t/abc/runs/r/sftp/" + "f" * 32 + "_invoices_2026_05.xml"
    )
