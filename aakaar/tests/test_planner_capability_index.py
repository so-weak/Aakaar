...
from aakaar.planner.embeddings import FakeEmbeddingsClient
from aakaar.shared.registry import (
    CapabilityDefinition,
    Registry,
    build_default_registry,
)
from aakaar.storage import ChromaVectorStore
...
def _make_index(tmp_path: Path) -> tuple[CapabilityIndex, Registry]:
    ...
    store = ChromaVectorStore(tmp_path, dim=embeddings.dim)
