    ...
    <div className="noise-shell app-shell grid h-full place-items-center overflow-hidden px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={onSubmit} className="card space-y-4 p-6">
          ...
          {/* Decorative SSO entry point — not wired to any provider yet.
              Disabled so it never interferes with the password flow above. */}
          ...
          <button
            ...
            disabled
            aria-disabled="true"
            title="SSO is not configured for this deployment"
          >
            <Globe size={15} />
            Sign in with SSO
          </button>
          <p className="text-center text-[11px] text-ink-500">
            SSO not configured for this deployment.
          </p>
        </form>
      </div>
    </div>
